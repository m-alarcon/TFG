...
*******************************************************************************/
    ...
    //XXX-Josembm: mejor definir las bandas antes que nada
    ...
    //XXX-Josembm: antes de incluir MiWi.h tiene que estar definida la estructura
    //CONNECTION_STATUS ya que se usa en el mismo
    #if defined(PROTOCOL_MIWI)
        #include "WirelessProtocols/MiWi/MiWi.h"
    #endif
    /***************************************************************************
